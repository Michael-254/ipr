...
<div class="container-fluid">
          ...
          <!-- Page Heading -->
    <form class="text-center border border-light p-5" action="{{route('todo.updateSLM',$todos->id)}}" method="post" enctype="multipart/form-data">
    @csrf
     @method('patch')
     ...
     <div class="form-row mb-4">
     <div class="col">
  	 <label class="h6 mb-0 font-weight-bold text-gray-800">Confirmed By</label>
     <select class="form-control" name="status" required="required">
  	 <option value="">Select Status</option><option value="SLM approved">SLM approved</option>
     ...
     <option value="SLO declined">SLO declined</option>
	   ...
	   <input type="date" readonly name="slmD"  value="{{ date('Y-m-d') }}" class="form-control" placeholder="SLM date" required="required">
     </div>
	   <div class="col">
	   <label class="h6 mb-0 font-weight-bold text-success">SLM Name</label>
	   <input type="text" name="slmN" readonly value="{{$user->name}}" class="form-control">
     </div>
	   <div class="col">
     ...
     <input type="hidden" readonly class="form-control" name="slmM" value="{{$user->email}}">
