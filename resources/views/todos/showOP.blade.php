...
@csrf
 ...
 <div class="form-row mb-4">
  ...
  <option value="">Select Status</option><option value="OP approved">OP approved</option>
  <option value="OP declined">OP declined</option></select>
  </div>
  <div class="col">
  <label class="h6 mb-0 font-weight-bold text-success">IPR Type</label>
  <select class="form-control" name="type" required="required">
  <option value="">Select Type</option><option value="opex">Opex</option>
  <option value="capex">Capex</option></select>
  </div>
<div class="col">
