...
<div class="container-fluid">
    ...
    @csrf
     ...
     <select class="form-control" name="status" required="required">
  	 <option value="">Select Status</option><option value="HOD approved">HOD approved</option>
  	 <option value="HOD declined">HOD declined</option></select>
     </div>
	   <div class="col">
	   <label class="h6 mb-0 font-weight-bold text-success">HOD Date Review</label>
	   <input type="date" name="hodD" readonly value="{{ date('Y-m-d') }}" class="form-control" placeholder="HOD date" required="required">
     </div>
	   <div class="col">
	   <label class="h6 mb-0 font-weight-bold text-success">HOD Name</label>
	   <input type="text" name="hodN" readonly value="{{$user->name}}" class="form-control">
     </div>
	   <div class="col">
     ...
     <input type="hidden" readonly class="form-control" name="hodM" value="{{$user->email}}">
